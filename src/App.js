...
function App() { 
    ...
    useEffect(() => { if (quotes) { handleNewQuote() } }, [quotes])
     ...
     return (
      ...
      <Header/>
      { 
        (currentQuote.quote === "") ? <Spinner className="loading-spinner" animation="grow" variant="light" role="status"> <span className="sr-only">Loading...</span> </Spinner> : <QuoteBox accentColor={accentColor} currentQuote={currentQuote} 
